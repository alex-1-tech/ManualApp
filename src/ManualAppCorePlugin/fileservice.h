...
public:
  ...
  QString getTempPath() { return QStandardPaths::writableLocation(QStandardPaths::TempLocation); };
  QString ensureAppDataDirectory();
  QString getFullFilePath(const QString& fileName);

private:
  void logFileOperation(const QString& operation, const QString& filePath, bool success,
